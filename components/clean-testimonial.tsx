...
export function Testimonial() {
  ...
  usePreloadImages(testimonials.map((t) => t.avatar || "/placeholder.svg"))
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-xl mx-auto py-20 px-8">
        <div className="space-y-6">
          ...
          <div className="h-px w-full bg-gray-200 mt-16" />
        </div>
      </div>
    )
  }
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <span className="block text-xs text-muted-foreground mt-0.5 font-mono uppercase tracking-widest">
                  {currentTestimonial.serviceType} — {currentTestimonial.location}
                </span>
              </motion.div>
            </AnimatePresence>
          </div>
